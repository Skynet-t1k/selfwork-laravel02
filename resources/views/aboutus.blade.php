...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav mx-auto">
                    ...
                    <a class="nav-link active mx-5" href="{{route('aboutus')}}">Chi Siamo</a>
    ...
    <div class="row">
        ...
        <div class="card" style="width: 18rem;">
            <img src="{{ $persona['imageurl'] }}" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">{{$persona['nome']}}</h5>
                <p class="card-text">{{$persona['ruolo']}}</p>
                <a href="{{route('dettaglio', ['id'=>$persona['id']])}}" class="btn btn-primary">Dettaglio</a>
            </div>
        </div>
        </div>
        @endforeach
